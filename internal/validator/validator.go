...
// Declare a regular expression to check email
...
// New creates a new validator with an empty Errors map
func New() *Validator {
	return &Validator{
...
// Unique returns true if a string value matches a specific regexp pattern
